                       ...
                       <div class="flex items-center">
                           <div class="hidden md:flex items-center">
                               <div class="text-white-800 text-right">
                                   <a href="tel:+7 918 009 92 97" class="text-xl xl:text-2xl font-semibold">+7 918 009 92 97</a>
                                   <span class="block text-gray-500 text-xs">Звоните ежедневно с 9:00 до 18:00</span>
                               </div>
                               <div class="ml-4">
                                   <ul class="nav-icon *:inline-block *:border *:border-gray-800 *:rounded-lg *:w-12 *:h-12 *:ml-1">
                                       <li class="relative hover:shadow-icon">
                                           <a href="#" class="flex w-full h-full items-center justify-center">
        ...
        <div class="h-full relative pl-6 pr-5 pt-24 pb-10 flex  justify-center flex-col">
            ...
            <div class="mt-10">
                <div class="text-white-800">
                    <a href="tel:+7 918 009 92 97" class="text-xl font-semibold">+7 918 009 92 97</a>
                    <span class="block text-gray-500 text-xs">Звоните ежедневно с 9:00 до 18:00</span>
                </div>
                <div class="mt-5">
